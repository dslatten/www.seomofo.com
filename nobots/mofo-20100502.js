...
function mofoWidgets(){
	if(document.getElementById('widget_holder')){
		...
		myWidgets.push("		<a href=\"http:\/\/twitter.com\/home?status=" + encodeURIComponent(document.title) + " - " + encodeURIComponent(document.URL) + "\"><span>Share this on Twitter!<\/span><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"delicious_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<a onclick=\"window.open('http:\/\/delicious.com\/save?v=5&amp;noui&amp;jump=close&amp;url='+encodeURIComponent('" + encodeURIComponent(document.URL) + "')+'&amp;title='+encodeURIComponent('" + encodeURIComponent(document.title) + "'),'delicious', 'toolbar=no,width=550,height=550'); return false;\" href=\"http:\/\/delicious.com\/save\"><span>Bookmark this on Delicious!<\/span><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"stumbleupon_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<a href=\"http:\/\/www.stumbleupon.com\/submit?url=" + encodeURIComponent(document.URL) + "&amp;title=" + encodeURIComponent(document.title) + "\"><span>Stumble this!<\/span><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"facebook_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<a href=\"http:\/\/www.facebook.com\/sharer.php?u=" + encodeURIComponent(document.URL) + "&amp;t=" + encodeURIComponent(document.title) + "\"><span>Share this on Facebook!<\/span><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"reddit_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<div>");
		myWidgets.push("			<iframe src=\"http://www.reddit.com/static/button/button3.html?width=69&amp;url=" + escape(document.URL) + "\" height=\"52\" width=\"69\" scrolling='no' frameborder='0'></iframe>");
		myWidgets.push("		<\/div>");
		myWidgets.push("	<\/div>");
