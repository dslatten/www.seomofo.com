...
function mofoWidgets(){
	if(document.getElementById('widget_holder')){
		...
		myWidgets.push("		<a href=\"http:\/\/twitter.com\/home?status=" + encodeURIComponent(document.title) + " - " + encodeURIComponent(document.URL) + "\"><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"delicious_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<a onclick=\"window.open('http:\/\/delicious.com\/save?v=5&amp;noui&amp;jump=close&amp;url='+encodeURIComponent('" + encodeURIComponent(document.URL) + "')+'&amp;title='+encodeURIComponent('" + encodeURIComponent(document.title) + "'),'delicious', 'toolbar=no,width=550,height=550'); return false;\" href=\"http:\/\/delicious.com\/save\"><\/a>");
		myWidgets.push("	<\/div>");
		myWidgets.push("	<div id=\"facebook_mofo\" class=\"post_widget_mofo\">");
		myWidgets.push("		<a href=\"http:\/\/www.facebook.com\/sharer.php?u=" + encodeURIComponent(document.URL) + "&amp;t=" + encodeURIComponent(document.title) + "\"><\/a>");
		myWidgets.push("	<\/div>");
