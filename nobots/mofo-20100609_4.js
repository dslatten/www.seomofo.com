...
function subscribeLinks(){
	if(document.getElementById('sub_box')){
		...
		subArray.push("		<a target=\"_blank\" class=\"affiliate\" href=\"http:\/\/www.seomofo.com\/affiliate\/scribe\/\" onclick=\"_gaq.push(['_trackEvent', 'Affiliates', 'Scribe', 'Sidebar - Custom 127x144']);\"><span>Scribe<\/span><\/a>");
		subArray.push("	<\/div>");
		subArray.push("<\/div>");
