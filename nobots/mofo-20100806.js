...
function subscribeLinks(){
	if(document.getElementById('sub_box')){
		...
		subArray.push("	<\/div>");
		subArray.push("	<div id=\"sub_raven\">");
		subArray.push("		<a target=\"_blank\" class=\"affiliate\" href=\"http:\/\/www.seomofo.com\/affiliate\/raven\/\" onclick=\"_gaq.push(['_trackEvent', 'Affiliates', 'Raven', 'Sidebar - 125x125']);\"><span>Raven<\/span><\/a>");
		subArray.push("	<\/div>");
